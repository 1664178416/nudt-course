...
if __name__ == "__main__":
    ...
    for row in tqdm(dicts[:]):
        ...
        df_money = df_money._append({'slug':row['slug'], 'earning_after_first_date':first_date_earning}, ignore_index=True)
    df_money.to_csv('news/20190730_patreon_adoption_dates.csv', index=False)
